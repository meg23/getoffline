...
class QueueRoutingTests(unittest.TestCase):
    ...
    def test_download_jobs_route_to_shared_download_queue(self):
        ...
        self.assertEqual(queue_name("download_single", {"source_type": "youtube"}), "getoffline.jobs.downloads")
        self.assertEqual(queue_name("download_episode", {"source_type": "podcast"}), "getoffline.jobs.downloads")
        self.assertEqual(queue_name("download_episode", {"source_type": "youtube"}), "getoffline.jobs.downloads")
