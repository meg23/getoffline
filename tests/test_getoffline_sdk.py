...
class GetOfflineSdkTests(unittest.TestCase):
    ...
    def test_client_convenience_methods_forward_to_transport(self):
        ...
        self.assertEqual(client.censor_download(3), {"ok": True})
        self.assertEqual(client.retry_job(9), {"ok": True})
        ...
        self.assertEqual(transport.calls[9][1], "/downloads/3/censor")
        self.assertEqual(transport.calls[10][1], "/jobs/9/retry")
