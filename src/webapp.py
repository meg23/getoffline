...
def _icon_sprite() -> str:
    ...
    <svg aria-hidden="true" style="position:absolute;width:0;height:0;overflow:hidden" focusable="false">
      ...
      <symbol id="bi-arrow-down-circle-fill" viewBox="0 0 16 16"><path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0M8 12a.5.5 0 0 0 .5-.5V5.707l1.146 1.147a.5.5 0 0 0 .708-.708l-2-2a.5.5 0 0 0-.708 0l-2 2a.5.5 0 1 0 .708.708L7.5 5.707V11.5A.5.5 0 0 0 8 12"/></symbol>
  ...
  <div class="container">
    ...
    <div class="panel">
      ...
      <form method="post" action="/update" class="toolbar-form">
        <button class="icon-button icon-button-primary" type="submit" title="Sync downloads" aria-label="Sync downloads" {button_disabled}>{_icon_use("bi-arrow-down-circle-fill")}</button>
      </form>
