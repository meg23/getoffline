...
urlpatterns = [
    ...
    path(
        "frontend/player/<int:episode_id>/next",
        views.frontend_next_player,
        name="api_frontend_next_player",
    ),
    ...
    path("playlists", views.playlists, name="api_playlists"),
    path("playlists/create", views.playlist_create, name="api_playlist_create"),
    path("playlists/<int:playlist_id>", views.playlist_detail, name="api_playlist_detail"),
    path("playlists/<int:playlist_id>/items", views.playlist_add_items, name="api_playlist_add_items"),
    path(
        "playlists/<int:playlist_id>/items/<int:download_id>/remove",
        views.playlist_remove_item,
        name="api_playlist_remove_item",
    ),
    path("playlists/<int:playlist_id>/delete", views.playlist_delete, name="api_playlist_delete"),
